...
<head>
    ...
    <title>Mental Care - Tambah Data Admin</title>
...
<form>
    ...
    <main id="main" class="main">
        ...
        <h1>
            <div class="text-dark"> Tambah Data Admin </div>
        </h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="text-dark breadcrumb-item active" aria-current="page">Tambah Data Admin</li>
            </ol>
        </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            ...
            <form method="post" action="{{ route('layouts.admin.data_admin.dataadmin_store') }}" enctype="multipart/form-data">
                @csrf
