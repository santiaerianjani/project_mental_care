...
<head>
    ...
    <title>Mental Care - Tambah Data Artikel</title>
...
<form>
    ...
    <main id="main" class="main">
        ...
        <h1>
            <div class="text-dark"> Tambah Data Artikel </div>
        </h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="text-dark breadcrumb-item active" aria-current="page">Tambah Data Artikel</li>
            </ol>
        </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            ...
            @endif
            <form method="post" action="{{ route('layouts.admin.data_artikel.dataartikel_store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" name="isi_artikel" rows="3"></textarea>
                </div>
                <div class="form-group mb-3">
                    <label for="link_artikel">Link Artikel</label>
                    <input type="url" class="form-control" id="link_artikel" name="link_artikel" required>
                </div>
                <form action="{{ route('layouts.admin.data_artikel.dataartikel') }}" method="POST" enctype="multipart/form-data">
                    @csrf
