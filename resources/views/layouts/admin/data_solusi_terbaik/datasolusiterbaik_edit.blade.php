...
<head>
    ...
    <title> Mental Care - Edit Data Solusi Terbaik </title>
...
<main id="main" class="main">
    ...
    <h1>
        <div class="text-dark"> Edit Data Solusi Terbaik </div>
    </h1>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="text-dark breadcrumb-item active" aria-current="page">Edit Data Solusi Terbaik</li>
        </ol>
    </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="indianred-bold-text card-title">Mengubah Data Solusi Terbaik</h5>

            <!-- Vertical Form -->
            <form class="row g-3" action="{{ route('layouts.admin.data_solusi_terbaik.datasolusiterbaik_edit', Crypt::encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="col-12">
                    <label for="inputNanme4" class="form-label">Kategori Depresi</label>
                    <input id="kategori_depresi" type="text" class="form-control @error('kategori_depresi') is-invalid @enderror" name="kategori_depresi" value="{{ $data->kategori_depresi }}" required autocomplete="kategori_depresi" autofocus>
                    @if ($errors->has('kategori_depresi'))
                    <span class="help-block">
                        <strong>{{ $errors->first('kategori_depresi') }}</strong>
                    </span>
                    @endif
                </div>
                <div class="col-12">
                    <label for="inputNanme4" class="form-label">Solusi Terbaik</label>
                    <input id="solusi_terbaik" type="text" class="form-control @error('solusi_terbaik') is-invalid @enderror" name="solusi_terbaik" value="{{ $data->solusi_terbaik }}" required autocomplete="solusi_terbaik" autofocus>
                    @if ($errors->has('solusi_terbaik'))
                    <span class="help-block">
                        <strong>{{ $errors->first('solusi_terbaik') }}</strong>
                    </span>
                    @endif
                </div>
                <div class="text-end">
