...
<head>
  ...
  <title>Mental Care - Lihat Data Solusi Terbaik</title>
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="d-flex">
                          ...
                          <!-- Modal -->
                          <div class="modal fade" id="exampleModal{{$diagnosas->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
