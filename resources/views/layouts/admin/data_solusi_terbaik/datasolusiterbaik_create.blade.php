...
<head>
  ...
  <title>Mental Care - Tambah Data Solusi Terbaik</title>
...
<form>
  ...
  <main id="main" class="main">
    ...
    <h1>
      <div class="text-dark"> Tambah Data Solusi Terbaik </div>
    </h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="text-dark breadcrumb-item active" aria-current="page">Tambah Data Solusi Terbaik</li>
      </ol>
    </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <form action="{{ route('layouts.admin.data_solusi_terbaik.datasolusiterbaik_store')}}" method="POST">
          @csrf
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="solusi_terbaik" rows="3" name="solusi_terbaik"></textarea>
          </div>
