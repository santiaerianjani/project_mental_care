        ...
        <div class="col-lg-12">
          <div class="d-grid gap-2 d-md-flex align-content-md-end">
            <a href="{{ route('layouts.user.hasil_solusi_terbaik.hasilsolusiterbaik_create')}}" class="btn btn-success" type="button">
              <i class="bi bi-plus"></i>Tambah Diagnosa </a>
          </div>
          <br>
          <div class="card ">
            <div class="card-body">
                    ...
                    <td>
                      <div class="d-flex">
                        <div class="d-flex">
                          ...
                          <!-- Modal -->
                          <div class="modal fade" id="exampleModal{{$hasilsolusiterbaikss->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
