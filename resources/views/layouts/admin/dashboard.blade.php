...
<main id="main" class="main">
  ...
  <h1>
    <div class="text-dark"> Dashboard </div>
  </h1>
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="text-dark breadcrumb-item"><a href="#">Home</a></li>
      <li class="text-dark breadcrumb-item active" aria-current="page">Dashboard</li>
    </ol>
  </nav>
  </div><!-- End Page Title -->
