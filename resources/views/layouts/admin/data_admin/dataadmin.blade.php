...
<head>
    ...
    <title>Mental Care - Data Admin</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <h1>
            <div class="text-dark"> Data Admin </div>
        </h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="text-dark breadcrumb-item active" aria-current="page">Data Admin</li>
            </ol>
        </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-grid gap-2 d-md-flex align-content-md-end">
                        <a href="{{ route('layouts.admin.data_admin.dataadmin_create')}}" class="btn btn-success">
                            <i class></i>Tambah </a>
                    </div>
                    <br>
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal{{$admins->id}}">
                                                    Edit
                                                </button>
                                    ...
                                    <!-- Edit Modal -->
                                    <div class="modal fade" id="editModal{{$admins->id}}" tabindex="-1" aria-labelledby="editModalLabel{{$admins->id}}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="editModalLabel{{$admins->id}}">Edit Data Admin</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <form action="{{ route('layouts.admin.data_admin.dataadmin_update', $admins->id) }}" method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
                                                                <!-- Form fields go here -->
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="email" name="email" value="{{ $admins->email }}">
                                                                </div>
                                                                <div class="form-group mb-3">
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <select class="form-select" id="role" name="role">
                                                                        ...
                                                                        <option value="pengguna" {{ $admins->role == 'pengguna' ? 'selected' : '' }}>Pengguna</option>
                                                                    </select>
                                                                </div>
                                                                <!-- Button container -->
                                    ...
                                    <div class="modal fade" id="deleteModal{{$admins->id}}" tabindex="-1" aria-labelledby="deleteModalLabel{{$admins->id}}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="deleteModalLabel{{$admins->id}}">Hapus Data Admin</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('layouts.admin.data_admin.dataadmin_destroy', $admins->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
