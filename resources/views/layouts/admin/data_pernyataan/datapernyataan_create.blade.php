...
<head>
    ...
    <title>Mental Care - Tambah Pernyataan</title>
...
<form>
    ...
    <main id="main" class="main">
        ...
        <h1>
            <div class="text-dark"> Tambah Data Pernyataan</div>
        </h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="text-dark breadcrumb-item active" aria-current="page">Tambah Data Pernyataan</li>
            </ol>
        </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <form action="{{ route('layouts.admin.data_pernyataan.datapernyataan_store')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="pernyataan">Pernyataan</label>
                        <input type="text" class="form-control" id="pernyataan" rows="3" name="pernyataan"></>
                    </div>
